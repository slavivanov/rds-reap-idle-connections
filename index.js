...
const timeout = setInterval(async () => {
  ...
  try {
    ...
    AND (application_name='encharge-domain' OR application_name='process-event' OR application_name='encharge-api' OR application_name='flow-steps' OR application_name='email-events' OR application_name='encharge-engine-serverless')
